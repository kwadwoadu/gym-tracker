...
const SEARCH_INDEX = [
  ...
  { label: "Cloud Sync", description: "Sync across devices", tab: "/settings/data" },
  { label: "Sync Frequency", description: "Auto, manual, 5min, 15min, 1hr", tab: "/settings/data" },
  { label: "Sync Now", description: "Manually trigger sync", tab: "/settings/data" },
