...
import { ChevronLeft, ChevronRight, Calendar, Loader2, UtensilsCrossed, Plus } from 'lucide-react';
...
export default function NutritionTodayPage() {
  ...
  return (
    <div className="max-w-lg mx-auto">
      ...
      {/* Combined Progress Bar with Quick Actions */}
        ...
        <div className="flex items-center justify-between mb-2">
          ...
          <div className="flex items-center gap-2">
            ...
            <Link href="/nutrition/plan">
              <Button variant="ghost" size="sm" className="h-7 text-xs text-[#CDFF00] hover:text-[#CDFF00]/80">
