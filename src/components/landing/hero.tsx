...
export function Hero() {
  return (
    <section className="relative min-h-screen flex items-center justify-center px-4 py-20 overflow-hidden">
      {/* Background gradient */}
      <div className="absolute inset-0 bg-gradient-to-b from-background via-background to-card-alt pointer-events-none" />
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center">
        ...
        >
          Track Your Lifts.
          <br />
          <span className="text-primary">Beat Your PRs.</span>
        </motion.h1>
        ...
        >
          <Link href="/sign-up">
            <Button
              size="lg"
              className="h-14 px-8 text-lg font-semibold bg-primary text-black hover:bg-primary/90 transition-colors"
            >
              Get Started Free
